  ...
  return (
    ...
    >
          ...
          <Stack gap="xs" style={{ width: 200 }}>
            ...
            <Select
              ...
              data={[
                {
                  value: '',
                  label: selectedElement.type === 'image' ? 'Static Image' : 'Static Text',
                },
                ...deck.fields.map((f) => ({ value: f.name, label: f.name })),
              ]}
            ...
            {!selectedElement.field && selectedElement.type === 'text' && (
              <TextInput
                ...
                onChange={(e) =>
                  updateElement(selectedElement.id, { staticText: e.currentTarget.value })
                }
                size="xs"
              />
            )}
            {!selectedElement.field && selectedElement.type === 'image' && (
              <Group gap={4}>
                <TextInput
                  ...
                  style={{ flex: 1 }}
                />
                <Button size="xs" variant="light" onClick={() => setGalleryModalOpen(true)}>
                  Select
                </Button>
              </Group>
            )}
          ...
          <>
            <Stack gap="xs" style={{ width: 220 }}>
              ...
              <Select
                ...
                onChange={(val) =>
                  updateElement(selectedElement.id, { fontFamily: val || undefined })
                }
                searchable
                size="xs"
              />
      ...
      <Modal
        ...
        title="Copy Element to Other Styles"
        zIndex={2000}
      >
        <Stack>
          ...
          {allStyles.length > 0 && (
            <>
              <Checkbox
                ...
                indeterminate={
                  selectedTargetStyles.length > 0 && selectedTargetStyles.length < allStyles.length
                }
                onChange={(e) =>
                  setSelectedTargetStyles(e.currentTarget.checked ? allStyles.map((s) => s.id) : [])
                }
              />
                  ...
                  <Checkbox
                    ...
                    onChange={(e) => {
                      if (e.currentTarget.checked) {
                        ...
                        setSelectedTargetStyles(
                          selectedTargetStyles.filter((id) => id !== style.id)
                        );
                      }
                    }}
                  />
          ...
          <Group justify="flex-end" mt="md">
            ...
            <Button onClick={handleCopy} disabled={selectedTargetStyles.length === 0}>
              Copy
            </Button>
          </Group>
        </Stack>
