...
export function DeckDetails({
  ...
  const performImport = async () => {
    ...
    try {
      const cards = await ImportCardsWithMapping(
        importTarget.path,
        importTarget.sheet,
        columnMapping
      );
      if (cards) {
        ...
        const resolveStyle = (styleNameOrId: string, type: 'front' | 'back') => {
          ...
          const foundEntry = Object.entries(styles).find(
            ([_, s]) => s.name.toLowerCase() === styleNameOrId.toLowerCase()
          );
        ...
        notifications.show({
          title: 'Success',
          message: `Imported ${reconciledCards.length} cards`,
        });
      }
    } catch (err) {
  ...
  return (
    <Container size="xl" fluid={fullWidth}>
            ...
            <Group>
                  ...
                  <Menu.Item
                    ...
                    rightSection={
                      <Switch
                        ...
                        onChange={(e) => setShowRawValues(e.currentTarget.checked)}
                      />
                    }
                  >
                    Show Raw Values
              ...
              <Menu shadow="md" width={200}>
                ...
                <Menu.Dropdown>
                  ...
                  <Menu.Item leftSection={<IconPlus size={14} />} onClick={handleImportClick}>
                    Import XLSX
                  </Menu.Item>
                  <Menu.Item leftSection={<IconTable size={14} />} onClick={handleExport}>
                    Export XLSX
                  </Menu.Item>
                </Menu.Dropdown>
              </Menu>
            ...
            <Tabs.Panel value="settings" pt="xs">
              <Stack gap="md" maw={600}>
                ...
                <Select
                  ...
                  onChange={(val) =>
                    setDeck({ ...deck, paperSize: (val as 'letter' | 'a4') || 'letter' })
                  }
                  data={[
                ...
                <Paper withBorder p="sm">
                  ...
                  <Group align="flex-start" grow>
                    <Stack gap="xs">
                      <Text size="sm" c="dimmed">
                        Fronts ({Object.keys(deck.frontStyles).length})
                      </Text>
                      <Stack gap={4}>
                    ...
                    <Stack gap="xs">
                      <Text size="sm" c="dimmed">
                        Backs ({Object.keys(deck.backStyles).length})
                      </Text>
                      <Stack gap={4}>
      ...
      >
        <Stack>
          ...
          <Group justify="flex-end">
            <Button variant="default" onClick={() => setSheetModalOpen(false)}>
              Cancel
            </Button>
      ...
      >
        <Stack>
          <Text size="sm" c="dimmed">
            Map your Excel columns to the required Card Wizard fields.
          </Text>
          ...
          <Group grow>
            <Select
              ...
              onChange={(val) =>
                setColumnMapping((prev) => ({ ...prev, generateIdFrom: val || '' }))
              }
              searchable
              clearable
            />
          ...
          <Group justify="flex-end" mt="md">
            <Button variant="default" onClick={() => setMappingModalOpen(false)}>
              Cancel
            </Button>
